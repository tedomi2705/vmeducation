        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Padding(
                  padding:
                      const EdgeInsets.only(top: 20, left: 25, bottom: 10)),
              serviceSection('assets/images/service1.png'),
              Align(
                  alignment: Alignment.center,
                  child: Text(AppData.service1, style: AppBarTitleStyle)),
              Padding(padding: const EdgeInsets.only(top: 30)),
              serviceSection('assets/images/service2.png'),
              Align(
                  alignment: Alignment.center,
                  child: Text(AppData.service2, style: AppBarTitleStyle)),
              Padding(padding: const EdgeInsets.only(top: 30)),
              serviceSection('assets/images/service3.png'),
              Align(
                  alignment: Alignment.center,
                  child: Text(AppData.service3, style: AppBarTitleStyle)),
              Padding(padding: const EdgeInsets.only(top: 30)),
              serviceSection('assets/images/service4.png'),
              Align(
                  alignment: Alignment.center,
                  child: Text(AppData.service4, style: AppBarTitleStyle)),
              Padding(padding: const EdgeInsets.only(top: 30)),
            ],
          ),
        ));
  ...
  return Align(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        image:
            DecorationImage(fit: BoxFit.cover, image: AssetImage(imageAsset)),
