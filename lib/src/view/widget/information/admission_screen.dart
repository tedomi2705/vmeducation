          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              expansionCallback: (int index, bool isExpanded) {
                ...
                children: AppData.admissionList.map<ExpansionPanel>((Admission admission) {
                  return ExpansionPanelRadio(
                    ...
                    headerBuilder: (BuildContext context, bool isExpanded) {
                      return ListTile(
                        ...
                        title: Text(admission.admissionTitle, style: ExpansionPanelTitleStyle),
                      );
                    },
                    body: ListTile(
                      title: Text(admission.admissionContent, style: const TextStyle(fontSize: 16)),
                    ),
                  );
                }).toList(),
              ),
